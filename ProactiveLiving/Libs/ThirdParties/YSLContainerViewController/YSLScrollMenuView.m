...
static const CGFloat _kYSLScrollMenuViewWidth  = 100;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemfont = [UIFont systemFontOfSize:10];
        _itemTitleColor = [UIColor clearColor];
        _itemSelectedTitleColor = [UIColor whiteColor];
        _itemIndicatorColor = [UIColor whiteColor];
