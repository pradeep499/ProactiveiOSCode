...
- (void)baseInit {
    _notSelectedStar = [UIImage imageNamed:@"ic_validation_stargray"] ;
    _selectedStar = [UIImage imageNamed:@"ic_validation_staryellow"];
    _halfSelectedStar = [UIImage imageNamed:@"ic_validation_starhalf"] ;
