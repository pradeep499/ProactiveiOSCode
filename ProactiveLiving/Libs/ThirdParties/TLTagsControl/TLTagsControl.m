...
- (void)commonInit {
    ...
    tagInputField_.layer.cornerRadius = CORNER;
    ...
    tagInputField_.enabled=NO;
    tagInputField_.font = [UIFont fontWithName:FONT_REGULAR size:14];
...
- (void)reloadTagSubviews {
    ...
    for (NSString *tag in _tags) {
        ...
        tagView.layer.cornerRadius = CORNER;
        ...
        tagLabel.layer.cornerRadius = CORNER;
...
- (void)deleteTagButton:(UIButton *)sender {
    ...
    //call delegate
    [tapDelegate tagsControl:self deletedAtIndex:index];
