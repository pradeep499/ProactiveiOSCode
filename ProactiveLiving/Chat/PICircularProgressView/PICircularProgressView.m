...
+ (void)initialize
{
    if (self == [PICircularProgressView class])
    {
        ...
        [appearance setThicknessRatio:0.20f];
        
        [appearance setInnerBackgroundColor:[UIColor clearColor]];
        [appearance setOuterBackgroundColor:[UIColor clearColor]];
        ...
        [appearance setProgressTopGradientColor:[UIColor blackColor]];
        [appearance setProgressBottomGradientColor:[UIColor blackColor]];
