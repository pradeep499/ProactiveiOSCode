...
//  ProactiveLiving
//
//  Created by Mohd Asim on 26/04/16.
...
@interface CertDetailsVC ()

- (IBAction)btnBackClick:(id)sender;

@end

@implementation CertDetailsVC
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cellImageView setImageWithURL:[NSURL URLWithString:[[self.arrMenueImages objectAtIndex:indexPath.item] valueForKey:@"image"]] placeholderImage:nil];
